...
-- Create test user (test@ejemplo.com)
-- Password: Test123!
-- Note: This hash will be generated by add_test_user.js script
-- The user will be created via the script to ensure proper bcrypt hashing
